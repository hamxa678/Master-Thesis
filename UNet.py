...
## EMA means Exponential Moving Average which is used to update the parameters of the model
## This is used to update the parameters of the model to the target model
## How? The parameters of the target model are updated by the parameters of the source model
## The parameters of the target model are multiplied by the decay rate and added to the parameters of the source model
## The parameters of the source model are multiplied by 1 - decay rate
## The target model is updated by the parameters of the source model
## The target model is updated by the decay rate
## The source model is updated by 1 - decay rate
## The target model is updated by the source model
